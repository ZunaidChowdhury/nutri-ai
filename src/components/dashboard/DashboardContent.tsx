  ...
  if (isLoading) {
    return (
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 animate-pulse">
        {[1, 2, 3, 4].map((i) => (
          <div key={i} className="rounded-2xl border border-[#DCE9E4] bg-white h-[100px]" />
        ))}
      </div>
    );
  }
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        {/* Foods Logged */}
        <div className="rounded-2xl border border-[#DCE9E4] bg-white p-5 flex items-center gap-4">
          <div className="flex-shrink-0 w-11 h-11 rounded-xl bg-[#DDF5F0] flex items-center justify-center">
            <svg className="w-5 h-5 text-[#007F78]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
              <path strokeLinecap="round" strokeLinejoin="round" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4" />
            </svg>
          </div>
          <div>
            <p className="text-xs font-medium text-[#849A95]">Foods Logged (30d)</p>
            <p className="text-2xl font-bold text-[#163330]">{logEntries.length}</p>
          </div>
        </div>

        {/* Total Calories */}
        <div className="rounded-2xl border border-[#DCE9E4] bg-white p-5 flex items-center gap-4">
          <div className="flex-shrink-0 w-11 h-11 rounded-xl bg-[#FEF3C7] flex items-center justify-center">
          ...
          <div>
            <p className="text-xs font-medium text-[#849A95]">Total Calories (30d)</p>
            <p className="text-2xl font-bold text-[#163330]">{totalCalories.toLocaleString()}</p>
          </div>
        </div>

        {/* Avg Calories/Day */}
        <div className="rounded-2xl border border-[#DCE9E4] bg-white p-5 flex items-center gap-4">
          <div className="flex-shrink-0 w-11 h-11 rounded-xl bg-[#EAF7DE] flex items-center justify-center">
            <svg className="w-5 h-5 text-[#65B82E]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
              <path strokeLinecap="round" strokeLinejoin="round" d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6" />
            </svg>
          </div>
          <div>
            <p className="text-xs font-medium text-[#849A95]">Avg Cal / Food</p>
            <p className="text-2xl font-bold text-[#163330]">
        ...
        <div className="rounded-2xl border border-[#DCE9E4] bg-white p-5 flex items-center gap-4">
          ...
          <div>
            <p className="text-xs font-medium text-[#849A95]">Macro Split (P/C/F)</p>
            <p className="text-lg font-bold text-[#163330]">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        <div className="rounded-2xl border border-[#DCE9E4] bg-white overflow-hidden">
          <div className="px-5 pt-5 pb-2">
            <h2 className="text-lg font-semibold text-[#163330]">Calories Over Time</h2>
            <p className="text-xs text-[#849A95] mt-0.5">Last 30 days</p>
          </div>
        ...
        <div className="rounded-2xl border border-[#DCE9E4] bg-white overflow-hidden">
          <div className="px-5 pt-5 pb-2">
            <h2 className="text-lg font-semibold text-[#163330]">Macro Breakdown</h2>
            <p className="text-xs text-[#849A95] mt-0.5">Aggregated over 30 days</p>
          </div>
          <div className="px-5 pb-5">
      ...
      <div className="rounded-2xl border border-[#DCE9E4] bg-white overflow-hidden">
        <div className="px-5 pt-5 pb-3 flex items-center justify-between flex-wrap gap-2">
          <h2 className="text-lg font-semibold text-[#163330]">Your 7-Day Meal Plan</h2>
          <div className="flex items-center gap-2">
            {mealPlan && (
              <button
                type="button"
                onClick={() => downloadMealPlanPdf(mealPlan)}
                className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-sm font-medium text-[#55706B] border border-[#DCE9E4] hover:bg-[#EEF7F3] transition-colors"
              >
            ...
            <Link
              href="/meal-plan"
              className="inline-flex items-center gap-1 px-3 py-1.5 rounded-lg text-sm font-medium text-[#007F78] hover:bg-[#DDF5F0] transition-colors !no-underline"
            >
        ...
        <div className="px-5 pb-5">
          {planLoading ? (
            <div className="animate-pulse space-y-3">
              <div className="h-24 rounded-xl bg-[#EEF7F3]" />
              <div className="h-24 rounded-xl bg-[#EEF7F3]" />
            </div>
          ) : mealPlan && planStart ? (
            <div className="flex flex-col gap-4">
              <div className="flex items-center justify-between text-sm text-[#849A95]">
                <span>
              ...
              {mealPlan.days.length > 3 && (
                <Link
                  href="/meal-plan"
                  className="text-center text-sm font-medium text-[#007F78] hover:text-[#005F5A] py-2 !no-underline"
                >
            ...
            <div className="rounded-xl bg-[#EEF7F3] border border-[#DCE9E4] p-8 flex flex-col items-center gap-3 text-center">
              ...
              <p className="text-sm font-medium text-[#163330]">No meal plan yet</p>
              <p className="text-xs text-[#849A95]">
      ...
      <div className="rounded-2xl border border-[#DCE9E4] bg-white overflow-hidden">
        <div className="flex items-start gap-3 border-l-4 border-l-[#007F78] px-5 pt-5 pb-3">
          <div className="flex-shrink-0 w-9 h-9 rounded-lg bg-[#DDF5F0] flex items-center justify-center mt-0.5">
            <svg className="w-5 h-5 text-[#007F78]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
              <path strokeLinecap="round" strokeLinejoin="round" d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z" />
            </svg>
          </div>
          <div className="flex-1">
            <h2 className="text-lg font-semibold text-[#163330]">AI Nutrition Analysis</h2>
            <p className="text-xs text-[#849A95] mt-0.5">Get AI-powered insights from your food log</p>
          </div>
          <button
            type="button"
        ...
        <div className="px-5 pb-5">
          ...
          {analysisError && (
            <div className="p-3 rounded-xl bg-red-50 text-red-600 border border-red-200 text-sm">
              {analysisError}
            </div>
          )}
      ...
      <div className="rounded-2xl border border-[#DCE9E4] bg-white overflow-hidden">
        <div className="px-5 pt-5 pb-3">
          <h2 className="text-lg font-semibold text-[#163330]">Recently Logged</h2>
          <p className="text-xs text-[#849A95] mt-0.5">Your last 5 food entries</p>
        </div>
        <div className="px-5 pb-5">
          {recentLogs.length === 0 ? (
            <div className="rounded-xl bg-[#EEF7F3] border border-[#DCE9E4] p-8 flex flex-col items-center gap-2 text-center">
              <div className="w-10 h-10 rounded-full bg-[#DDF5F0] flex items-center justify-center">
                <svg className="w-5 h-5 text-[#007F78]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                  <path strokeLinecap="round" strokeLinejoin="round" d="M12 6v6m0 0v6m0-6h6m-6 0H6" />
                </svg>
              </div>
              <p className="text-sm text-[#55706B]">No foods logged yet.</p>
              <p className="text-xs text-[#849A95]">Tap &quot;Log Meal&quot; above to track what you eat.</p>
            </div>
          ) : (
            <div className="flex flex-col divide-y divide-[#DCE9E4]">
              {recentLogs.map((entry) => (
                <div
                  key={entry._id}
                  className="flex items-center justify-between py-3 group hover:bg-[#F7FAF8] -mx-2 px-2 rounded-lg transition-colors"
                >
                  <div className="flex flex-col gap-1 min-w-0">
                    <p className="font-medium text-sm text-[#163330] truncate">{entry.name}</p>
                    <div className="flex items-center gap-2 flex-wrap">
                      ...
                      <div className="flex items-center gap-1">
                        <span className="text-[10px] font-medium px-1.5 py-0.5 rounded bg-[#DDF5F0] text-[#007F78]">
                  ...
                  <div className="flex items-center gap-3 flex-shrink-0">
                    <div className="text-right">
                      <p className="font-semibold text-sm text-[#163330]">{entry.calories}</p>
                      <p className="text-[10px] text-[#849A95]">cal</p>
                    </div>
                    <button
                      type="button"
                      onClick={() => handleDeleteLog(entry._id)}
                      className="text-[#849A95] hover:text-red-500 transition-colors p-1 opacity-0 group-hover:opacity-100"
          ...
          <Modal.Container placement="center" size="lg">
            <Modal.Dialog>
              ...
              <Modal.Body>
                    ...
                    <button
                      ...
                      className={`px-3.5 py-1.5 text-sm font-medium rounded-lg transition-colors ${
                        logTab === key
                          ...
                          : 'bg-[#EEF7F3] hover:bg-[#DDF5F0] text-[#55706B]'
                      }`}
                    >
                      {label}
                    </button>
                ...
                {logError && (
                  <div className="p-2.5 rounded-xl bg-red-50 text-red-600 border border-red-200 text-sm mb-3">
                    {logError}
                  </div>
                )}
                ...
                {logTab === 'meals' && (
                  <div className="flex flex-col gap-4">
                    <div className="max-h-[260px] overflow-y-auto border border-[#DCE9E4] rounded-xl">
                      {meals.length === 0 ? (
                        <p className="p-4 text-sm text-[#849A95] text-center">No meals in your catalog yet.</p>
                      ) : meals.map((meal) => (
                        <button
                          key={meal._id}
                          type="button"
                          onClick={() => setSelectedMealId(meal._id)}
                          className={`w-full text-left flex items-center justify-between px-4 py-3 border-b border-[#DCE9E4] last:border-0 transition-colors ${
                            selectedMealId === meal._id ? 'bg-[#DDF5F0]' : 'hover:bg-[#EEF7F3]'
                          }`}
                        >
                          <div className="flex flex-col min-w-0">
                            <span className="font-medium text-sm text-[#163330] truncate">{meal.title}</span>
                            <span className="text-xs text-[#849A95]">{meal.cuisineTag}</span>
                          </div>
                          <span className="font-semibold text-sm text-[#55706B] whitespace-nowrap ml-3">{meal.calories} cal</span>
                        </button>
                      ))}
                    </div>
                    <div className="grid grid-cols-2 gap-3">
                      <div className="flex flex-col gap-1">
                        <span className="text-xs text-[#849A95] font-medium">Servings</span>
                        <input
                          type="number"
                          min={0.5}
                          step={0.5}
                          ...
                          className="px-3 py-2 rounded-lg border border-[#DCE9E4] bg-white text-sm text-[#163330] focus:outline-none focus:ring-2 focus:ring-[#007F78]/30 focus:border-[#007F78]"
                        />
                      </div>
                      <div className="flex flex-col gap-1">
                        <span className="text-xs text-[#849A95] font-medium">Date</span>
                        <input
                          type="date"
                          value={mealDate}
                ...
                {logTab === 'plan' && mealPlan && (
                  <div className="flex flex-col gap-4">
                    <div className="flex flex-col gap-1">
                      <span className="text-xs text-[#849A95] font-medium">Day</span>
                        ...
                        {mealPlan.days.map((day, i) => (
                          <button
                            ...
                            className={`px-3 py-1.5 text-sm font-medium rounded-lg transition-colors ${
                              planDayIdx === i ? 'bg-[#007F78] text-white' : 'bg-[#EEF7F3] text-[#55706B] hover:bg-[#DDF5F0]'
                            }`}
                          >
                            Day {day.day}
                          </button>
                    ...
                    <div className="flex flex-col gap-1">
                      <span className="text-xs text-[#849A95] font-medium">Meal</span>
                          ...
                          <button
                            ...
                            className={`w-full text-left flex items-center justify-between px-4 py-3 rounded-xl border transition-colors ${
                              planMealIdx === i
                                ...
                                : 'border-[#DCE9E4] hover:bg-[#EEF7F3]'
                            }`}
                          >
                            <span className="font-medium text-sm text-[#163330]">{m.name}</span>
                            <span className="font-semibold text-sm text-[#849A95]">{m.calories} cal</span>
                          </button>
                        ))}
                      </div>
                    </div>
                ...
                {logTab === 'plan' && !mealPlan && (
                  <p className="text-sm text-[#849A95] text-center py-6">
                ...
                {logTab === 'custom' && (
                  <div className="flex flex-col gap-4">
                    <div className="flex flex-col gap-1">
                      <span className="text-xs text-[#849A95] font-medium">Food name</span>
                      <input
                        type="text"
                        value={customName}
                        onChange={(e) => setCustomName(e.target.value)}
                        placeholder="e.g. Post-workout Protein Shake"
                        className="px-3 py-2 rounded-lg border border-[#DCE9E4] bg-white text-sm text-[#163330] placeholder:text-[#849A95] focus:outline-none focus:ring-2 focus:ring-[#007F78]/30 focus:border-[#007F78]"
                      />
                    </div>
                    <div className="grid grid-cols-2 gap-3">
                      <div className="flex flex-col gap-1">
                        <span className="text-xs text-[#849A95] font-medium">Calories</span>
                        <input
                          type="number"
                          min={0}
                      ...
                      <div className="flex flex-col gap-1">
                        <span className="text-xs text-[#849A95] font-medium">Protein (g)</span>
                        <input
                          type="number"
                          min={0}
                          value={customProtein}
                      ...
                      <div className="flex flex-col gap-1">
                        <span className="text-xs text-[#849A95] font-medium">Carbs (g)</span>
                        <input
                          type="number"
                          min={0}
                          value={customCarbs}
                      ...
                      <div className="flex flex-col gap-1">
                        <span className="text-xs text-[#849A95] font-medium">Fat (g)</span>
                        <input
                          type="number"
                          min={0}
                          value={customFat}
