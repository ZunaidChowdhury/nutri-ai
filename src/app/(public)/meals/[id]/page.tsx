        ...
        <div className="flex flex-col gap-6">
          <div className="flex flex-col gap-2">
            <div className="flex items-start justify-between gap-2">
              ...
              <Chip variant="soft" size="sm" className="shrink-0 mt-1">
                {meal.cuisineTag}
              </Chip>
            </div>
          ...
          <div className="flex flex-col gap-3 p-4 rounded-xl bg-surface-secondary">
            <h2 className="text-sm font-semibold uppercase tracking-wider text-muted">
              Nutritional Information
            </h2>
            <MacroBar label="Protein" value={meal.macros.protein} total={totalMacros} color="bg-accent" />
